...
function initBuffers(){
  loadObject('jellyfish0','/static/igame/meshes/jellyfish0.json');
  loadObject('jellyfish1','/static/igame/meshes/jellyfish1.json');
  loadObject('jellyfish2','/static/igame/meshes/jellyfish2.json');
  loadObject('jellyfish3','/static/igame/meshes/jellyfish3.json');
}
