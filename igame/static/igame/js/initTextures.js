...
function initTextures() {
  loadTexture('jellyfish', '/static/igame/images/jellyfish.png');
  loadTexture('luminescence', '/static/igame/images/luminescence.png');

  for (var i=1; i <= 32; i++) {
    loadTexture('caustics'+i, '/static/igame/images/caustics/caustics7.'+pad2(i-1)+'.jpg');
  }
}
